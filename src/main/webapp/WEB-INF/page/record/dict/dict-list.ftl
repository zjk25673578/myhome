            ...
            <div class="layui-field-box">
                ...
                <form id="search-form" class="layui-form layui-col-md12">
                    <div class="layui-form-item layui-col-space20">
                        <div class="layui-col-lg1 layui-col-md2 layui-col-sm2 layui-col-xs2">
                            <input class="layui-input" name="ids" placeholder="代码代号">
                        </div>
                        <div class="layui-col-lg2 layui-col-md3 layui-col-sm5 layui-col-xs10">
